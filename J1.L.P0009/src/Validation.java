...
public class Validation {
    ...
    public static double getDouble(String msg, double min, double max, boolean check) {
        while (true) {
            System.out.print(msg);
            String s = sc.nextLine();
            if (s.isEmpty()) {
    ...
    public static String getString(String msg, String formatMsg, String regex, boolean check) {
        while (true) {
            System.out.print(msg);
            String s = sc.nextLine();
            if (s.isEmpty()) {
